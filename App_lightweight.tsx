...
const App: React.FC = () => {
  ...
  return (
    <div className={`w-full h-screen flex flex-col overflow-hidden ${currentThemeColors.app_bg} ${currentThemeColors.text}`}>
      {/* Header */}
      <NewHeader 
        selectedPair={selectedPair}
        setSelectedPair={setSelectedPair}
        selectedInterval={interval}
        setSelectedInterval={setInterval}
        theme={theme}
      ...
      {isIndicatorModalOpen && (
        <Modal onClose={toggleIndicatorModal}>
          <IndicatorPanel
